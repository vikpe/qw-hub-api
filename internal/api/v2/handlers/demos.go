...
func Demos(demoProvider func() []types.QtvHostedDemo) func(c *fiber.Ctx) error {
...
func FilterDemos(allDemos []types.QtvHostedDemo, params *DemoParams) []types.QtvHostedDemo {
	result := make([]types.QtvHostedDemo, 0)
